...
& 包体为json字符串，参数如下：
 ...
 {<br/>
     ...
     `"params"` : `"008618972898133,123456,5;008615335868181,123,8;008613451210653,qqqq"`,   //手机号码和变量参数，手机号码放在第一位。多组参数使用英文分号;区分。最多支持20个变量。params字段最多不超过1000个参数组。格式不符的参数，系统自动过滤。必填<br/>
